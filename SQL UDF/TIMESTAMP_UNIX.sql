...
Convert timestamp unix style timestamp.
	Number Seconds from 1.1.1970

Incoming Parameter:
 - Timestamp
 
Returns unix timestamp or -1 on failure
*/
...
COMMENT ON PARAMETER SPECIFIC FUNCTION YOUR_SCHEMA.TS_UNIX (PARM_TIMEZONE IS 'Timezone (-)HHMMSS'); 

LABEL ON SPECIFIC FUNCTION YOUR_SCHEMA.TS_UNIX IS 'Timestamp in unix-format'; 
